...
<html>
<head>
<title>Rexfashion</title>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" href="https://www.rexfashion.com/w3css/4/w3.css">
...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-container w3-center w3-padding-48 w3-white">
    <h1 class="w3-xxxlarge"><b>ELOHOR EDERHI AND ESE EDERHI</b></h1>
    <h6>Welcome to the blog of <span class="w3-tag">Jane's world</span></h6>
  </header>

  <!-- Image header -->
  <header class="https://drive.google.com/file/d/1ZoxeXNFkuQyQY1AYklFhglDXGQwbtx3C/view?usp=drivesdk" id="home">
...
<footer class="w3-container w3-dark-grey" style="padding:32px">
  ...
  <p>Powered by <a href="https://www.www.rexfashion.com/" target="_blank">EDERHI DAVID.REX</a></p>
</footer>
